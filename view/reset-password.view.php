   ...
   <div class="row">
      <section class="col-xs-12 col-md-9">
         <form class="form-horizontal formulario" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
            <h2 class="text-center">Cambio de contraseña olvidada</h2>
            ...
            <input type="hidden" name="nombre" value="<?php echo $usuario['nombre_usuario']; ?>">
            <input type="hidden" name="correo" value="<?php echo $usuario['correo_usuario']; ?>">
